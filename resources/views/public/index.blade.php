...
<div class="container hero py-10">
        ...
        <div class="container intro-text py-7">
          <div class="row d-flex align-items-center justify-content-center">
            <div class="col-md-6">
              ...
              <h3 class="text-white fs-5" data-aos="fade-left">Facilitate</h3>
              ...
              <h3 class="text-white fs-5" data-aos="fade-left">Build</h3>
  ...
  <div class="py-20 position-relative overflow-x-hidden">
    <div class="circle circle1"></div>
      <div class="circle circle2"></div>
    <div class="container">
      <div class="row mb-5">
        <div class="col-lg-4">
          <h2 data-aos="fade-right" class="display-header mb-4">For Researchers</h2>
          {{-- <h4 data-aos="fade-right">Join us in creating innovative solutions for UConn!</h4> --}}
          <p data-aos="fade-right">I3 operates a Digital Services Core (the Digital Experience Group), providing top-tier app development, web design, UI/UX design, and other innovative technology services, helping researchers bring their grant funded projects to life with cutting-edge digital solutions.</p>
          <ul data-aos="fade-right">
            <li>Consultation &amp; Quote for Digital Services</li>
            <li>Custom Web &amp; Application Development</li>
            <li>Aurora &amp; WordPress Development</li>
            <li>Data Visualization &amp; Reporting</li>
            <li>Domain Name Management &amp; Hosting</li>
            <li>Grant-Friendly</li>
          </ul>
          <div data-aos="fade-right" class="btn display-btn btn-arrow-slide"> <a href="#contact" class="btn-arrow-slide-cont btn-arrow-slide-cont--blue" style="width:270px"> <span class="btn-arrow-slide-circle" aria-hidden="true"> <span class="btn-arrow-slide-arrow btn-arrow-slide-icon"></span> </span> <span class="btn-arrow-slide-text"> Request a Consultation </span> </a> </div>
        </div>
        <div class="col-lg-4 mb-3" data-aos="flip-right">
          <div class="card h-100" style="background:#E5EDFB;">
            <img src="/img/work/wellscan.png" class="card-img-top" alt="WellSCAN project">
            <div class="card-body">
              <h5 class="card-title">WellSCAN</h5>
              <p class="card-text">In collaboration with UConn's Rudd Center on Food Policy and Obesity, and with support from Partnership For Healthier America, Feeding America, and others, the DX Lab has developed a suite of web/mobile applications product for use by food banks, food pantries, and other organizations for ranking the nutritional quality of their inventory.</p>

              {{-- <a href="https://rif.core.uconn.edu" class="btn btn-primary">Visit RIF</a> --}}
              <div class="btn display-btn btn-arrow-slide"> <a href="https://wellscan.io/" target="_blank"
                class="btn-arrow-slide-cont btn-arrow-slide-cont--blue" style="width:140px"> <span
                  class="btn-arrow-slide-circle" aria-hidden="true"> <span
                    class="btn-arrow-slide-arrow btn-arrow-slide-icon"></span> </span> <span
                  class="btn-arrow-slide-text"> Visit </span> </a> </div>
            </div>
          </div>
        </div>
        <div class="col-lg-4 mb-3" data-aos="flip-right">
          <div class="card h-100" style="background:#E5EDFB;">
            <img src="/img/work/financial-game.png" class="card-img-top" alt="Breadwinner game">
            <div class="card-body">
              <h5 class="card-title">Breadwinner</h5>
              <p class="card-text">In collaboration with UConn Extension, the Digital Experience Group created a game with the purpose of teaching others about how to manage your money in the Connecticut workforce. Test your ability to budget and learn what you value the most when making financial decisions!</p>

              <div class="btn display-btn btn-arrow-slide"> <a href="https://breadwinner.netlify.app/" target="_blank"
                class="btn-arrow-slide-cont btn-arrow-slide-cont--blue" style="width:140px"> <span
                  class="btn-arrow-slide-circle" aria-hidden="true"> <span
                    class="btn-arrow-slide-arrow btn-arrow-slide-icon"></span> </span> <span
                  class="btn-arrow-slide-text"> Play </span> </a> </div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row pt-4">
        <div class="col-md-3 d-flex flex-column text-center" data-aos="fade-up">
          <h3 style="font-weight:400;font-size:50px;color:var(--accent-1)">30+</h3>
          <p>Grant-funded projects</p>
        </div>
        <div class="col-md-3 d-flex flex-column text-center" data-aos="fade-up">
          <h3 style="font-weight:400;font-size:50px;color:var(--accent-1)">25+</h3>
          <p>UConn Students Employed in Accelerator</p>
        </div>          
        <div class="col-md-3 d-flex flex-column text-center" data-aos="fade-up">
          <h3 style="font-weight:400;font-size:50px;color:var(--accent-1)">30%</h3>
          <p>Cost-savings on Average (compared to External Vendors)</p>
        </div>
        <div class="col-md-3 d-flex flex-column text-center" data-aos="fade-up">
          <h3 style="font-weight:400;font-size:50px;color:var(--accent-1)">15+</h3>
          <p>UConn Departments &amp; Centers Partnered</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="build text-white py-20 position-relative" id="build">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4">
          <h2 data-aos="fade-right" class="text-white display-header mb-4">For UConn and Beyond</h2>
          {{-- <h4 data-aos="fade-right" class="text-white">Join us in creating innovative solutions for UConn!</h4> --}}
          <p data-aos="fade-right">We partner with UConn administration and departments to enhance their systems through tailored digital solutions. Whether developing custom tools or optimizing existing resources, our goal is to provide digital services that simplify and improve the experience for UConn faculty, staff, and students.</p>
