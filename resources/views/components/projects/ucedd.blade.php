...
<x-projects.template-modal modalId="{{ $modalId }}" title="UConn Center for Excellence in Developmental Disabilities Education, Research and Service" :$links :$badges>
    <img loading="lazy" height="450" src="/img/work/ucedd.png" alt="UConn Center for Excellence in Developmental Disabilities Education, Research and Service graphic" class="img-fluid mb-3">
